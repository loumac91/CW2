...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    String[] exampleResult = BubbleSort.sort(example);

    System.out.println("This is sorted to: ");
    for (String name : exampleResult) {
